...
CODEX_EXEC_MODEL="${STATE_LOOP_REVIEWER_MODEL:-${STATE_CODEX_MODEL:-$DEFAULT_CODEX_MODEL}}"
CODEX_EXEC_EFFORT="${STATE_LOOP_REVIEWER_EFFORT:-${STATE_CODEX_EFFORT:-$DEFAULT_CODEX_EFFORT}}"
CODEX_REVIEW_MODEL="${STATE_LOOP_REVIEWER_MODEL:-${STATE_CODEX_MODEL:-$DEFAULT_CODEX_MODEL}}"
CODEX_REVIEW_EFFORT="${STATE_LOOP_REVIEWER_EFFORT:-${STATE_CODEX_EFFORT:-$DEFAULT_CODEX_EFFORT}}"
